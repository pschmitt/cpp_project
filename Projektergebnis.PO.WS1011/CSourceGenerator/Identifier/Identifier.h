...
public:
  ...
  enum IdentifierType { VARIABLE, CONSTANT, ENUM, CLASS, STRUCT, FUNCTION, PARAMETER, WORKSPACE, PROJECT, MODUL, UNKNOWN};
 
  Identifier (const string& name, IdentifierType type = UNKNOWN, const string& _description = "") throw (std::string);
